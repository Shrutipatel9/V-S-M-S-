...
<html>
<head>
	<title>V S M S_REGISTRATION </title>
...
<form action="register.php" method="post">
  ...
  <div class="form-group mx-sm-3">
    ...
    <select class="form-control" name="ccity" required>
      ...
      <option value="Nadaid">Nadaid</option>
...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO  `sgp1`.`customer_reg` (`cid` ,`cname` ,`gender` ,`cemail` ,`cpassword` ,`cphone` ,`ccity` ,`pincode` ,`emergencycontact`)VALUES (NULL,  '$cname',  '$gender',  '$email',  MD5('" . $password . "'),  '$phone',  '$city',  '$pincode',  '$emergencycontact');";
