...
<!-- Pirobox setup and styles end-->
    ...
    <br> <br> <br>
    <font color="maganta" face="Comic Sans MS">
    	<div id="wrap">	
		      <div id="top_padding">
					<div id="logo">
						<h1><b>V S M S</b></h1>
				...
				<div id="content_bg_repeat">
							...
							<div id="user_dialog" title="Add Data">
								<form method="post" id="user_form">
									...
									<div class="form-group">
										...
										<input type="text" name="varea" id="varea" class="form-control" />
										<span id="error_varea" class="text-danger"></span>
									</div>
									<div class="form-group">
					...
					$(document).ready(function(){  
						...
						$('#user_form').on('submit', function(event){
							...
							if($('#vtype').val() == '')
							{
								error_varea = 'Area is required';
								$('#error_varea').text(error_vtype);
								$('#varea').css('border-color', '#cc0000');
							}
							else
							{
								error_varea = '';
								$('#error_varea').text(error_vtype);
								$('#varea').css('border-color', '');
							}
							...
							if(error_vcat != '' || error_vtype != '' || error_vname != '' || error_varea != '' || error_mid != '')
							{
								return false;
							}
							else
