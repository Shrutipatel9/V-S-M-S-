    ...
    <br> <br> <br>
    	<div id="wrap">	
				...
				<div id="prew_img">
			     ...
			     <li><img src="images/bike2.jpg" alt="" /></li>
			     <li><img src="images/c5.jpg" alt="" /></li>
			     <li><img src="images/c11.jpg" alt="" /></li>
			     <li><img src="images/c8.jpg" alt="" /></li>
			     <li><img src="images/bike3.jpg" alt="" /></li>
				 <li><img src="images/car4.jpg" alt="" /></li>
           </ul>
          ...
          <script type="text/javascript">
				...
				<p style="font-face:comic sans ms"><img src="images/m5.jpg" height=300px width=400px style="float:left">
					...
					<img src="images/c11.jpg" align="right" height=300px width=490px style="margin-top:170px">
					...
					<img src="images/M11.jpg" height=320px width=450px style="margin-top:160px">
